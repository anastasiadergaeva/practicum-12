...
const makeEight = () => {
	const num1 = 123;
	const num2 = 10;
	resultEight.textContent = `${num1 % num2}`;
};
...
const makeTen = () => {
	const str = 'Hello';
	const secondSymbol = str[2];
	resultTen.textContent = secondSymbol;
};
...
const makeEleven = () => {
	const numberForOperation = 5;
	const moduleNumber = 2;
	resultEleven.textContent = `${numberForOperation % moduleNumber}`;
};
...
const makeThirteen = () => {
	...
	resultThirteen.textContent = lengthOfString;
};
...
const makeSixteen = () => {
	const str = 'JavaScript';
	resultSixteen.textContent = str.substring(3, str.length);
};
...
const makeNineteen = () => {
	const str = 'Hello, world!';
	const newStr = str.substr(7, 6);
	resultNineteen.textContent = newStr;
};
...
const makeTwentySeven = () => {
	const randomNumber = Math.floor(Math.random() * (100 - 5 + 1)) + 50;
