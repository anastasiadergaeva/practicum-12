...
const newText = result.substring(26, 50); // взяла 26, тк взялась не полностью строка
...
const index = lukomoryeText.indexOf('моря');
...
console.log(`1. Количество символов в тексте: ${lukomoryeText.length}`);
